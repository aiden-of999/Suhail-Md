...
module.exports = {
  ...
  botname : process.env.BOT_NAME  || "Aiden_of999-jnr",
  ownername:process.env.OWNER_NAME|| "Aden_of999",


  errorChat : process.env.ERROR_CHAT || "",
  KOYEB_API : process.env.KOYEB_API  || "false",

  REMOVE_BG_KEY : process.env.REMOVE_BG_KEY  || "sRV8EV9H469tZQm2P93J89RP",
